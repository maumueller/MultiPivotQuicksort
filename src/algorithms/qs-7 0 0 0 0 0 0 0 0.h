    ...
    void sort(Iterator left, Iterator right)
    {
        ...
        {
        networks::sort7(*(left +  0), *(left +  1), *(left +  2), *(left +  3), *(right - 2), *(right - 1), *(right - 0));
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (*j > p3)
                            {
                                ...
                                rotations::rotate5(*i, *j, *g4, *g5, *g6);
                                i++, j--, g4--, g5--, g6--;
                            }
                            else
                            {
                                if (*j > p2)
                                {
                                    ...
                                    rotations::rotate6(*i, *g3, *j, *g4, *g5, *g6);
                                    i++, j--, g3++, g4--, g5--, g6--;
                                }
                                else
                                {
                                    if (*j > p1)
                                    {
                                        ...
                                        rotations::rotate7(*i, *g3, *g2, *j, *g4, *g5, *g6);
                                        i++, j--, g3++, g2++, g4--, g5--, g6--;
                                    }
                                    else
                                    {
                                        // rotate a7 and a0 elements
                                        rotations::rotate8(*i, *g3, *g2, *g1, *j, *g4, *g5, *g6);
                                        i++, j--, g3++, g2++, g1++, g4--, g5--, g6--;
                                    }
                                }
                            }
                        }
        ...
        rotations::rotate5(*(left + 3), *(g1 - 1), *(g2 - 1), *(g3 - 1), *(i - 1));
        rotations::rotate4(*(left + 2), *(g1 - 2), *(g2 - 2), *(g3 - 2));
        rotations::rotate3(*(left + 1), *(g1 - 3), *(g2 - 3));
        rotations::rotate2(*(left + 0), *(g1 - 4));

        rotations::rotate4(*(right - 2), *(g6 + 1), *(g5 + 1), *(g4 + 1));
        rotations::rotate3(*(right - 1), *(g6 + 2), *(g5 + 2));
        rotations::rotate2(*(right - 0), *(g6 + 3));
...
CONTESTANT_REGISTER_ALL(qsort, "qsort700000000", "Quicksort, 7 pivots");
